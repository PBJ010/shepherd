          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Visibility(
                ...
                child: Text(
                  '${args.name}님의 맥박이 ${((100 - args.percent) / 100 * 20).round().toString()}분 후에 회복될 것입니다',
                  style: TextStyle(
                    fontWeight: FontWeight.w400,
                    color: Colors.black,
                    fontSize: 18,
                ...
                child: Column(
                  children: <Widget>[
                    Align(
                      alignment: Alignment.topCenter,
                      child: Text(
                        '  담배 안의 화학물질들은 맥박을 빠르게 하여 심장에 불필요한 부하를 줍니다. 인간의 심장은 근육으로 이루어져 있으며, 만약 심장이 오랜 기간 무리하여 일하면 심장이 더 이상 뛰지 않고 멈출 수 있습니다.',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 15,
                          fontWeight: FontWeight.w400,
                    ...
                    Align(
                      alignment: Alignment.topCenter,
                      child: Text(
                        '하지만 금연한다면 맥박은 흡연하기 이전 건강한 사람 수준으로 돌아갑니다.',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 15,
                          fontWeight: FontWeight.w400,
