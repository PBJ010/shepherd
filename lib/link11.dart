...
import 'package:shepherd/tool13.dart';
import 'package:shepherd/tool15.dart';
import 'package:shepherd/tool16.dart';
import 'package:shepherd/tool3.dart';
import 'package:shepherd/tool5.dart';
import 'package:shepherd/tool6.dart';

class Link11 extends StatefulWidget {
  const Link11({Key? key, required this.name,}) : super(key: key);
  final String name;

  @override
  State<Link11> createState() => _Link11State();
}

class _Link11State extends State<Link11> {
  @override
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Tool13(name: widget.name)));
                                      },
                                      child: Padding(
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Tool15(name: widget.name)));
                                      },
                                      child: Padding(
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Tool16(name: widget.name)));
                                      },
                                      child: Padding(
