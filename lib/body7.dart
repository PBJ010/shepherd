...
class Body7 extends StatefulWidget {
  const Body7({Key? key}) : super(key: key);

  @override
  _Body7State createState() => _Body7State();
}

class _Body7State extends State<Body7> {
  num completion = 0;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Visibility(
                ...
                child: Text(
                  '${args.name}님의 후각이 ${((100 - args.percent) / 100 * 48).round().toString()}시간 후에 회복될 것입니다',
                  style: TextStyle(
                    fontWeight: FontWeight.w400,
                    color: Colors.black,
                    fontSize: 18,
                ...
                child: Column(
                  children: <Widget>[
                    Align(
                      alignment: Alignment.topCenter,
                      child: Text(
                        '  흡연자들은 냄새 맡는 능력이 저하될 수 있습니다. 담배의 독성 물질이 코의 신경을 손상시키기 때문입니다. ',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 15,
                          fontWeight: FontWeight.w400,
                    ...
                    Align(
                      alignment: Alignment.topCenter,
                      child: Text(
                        '하지만 금연한다면, 후각이 회복되어 오늘 저녁으로 뭐가 조리되고 있는지 가장 먼저 알아차릴 수 있습니다!',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 15,
                          fontWeight: FontWeight.w400,
