...
class Body11 extends StatefulWidget {
  ...
  @override
  _Body11State createState() => _Body11State();
}
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Visibility(
                ...
                child: Text(
                  '${args.name}님의 감각신경수용기는 완전히 회복되었습니다',
                  style: TextStyle(
              ...
              Visibility(
                ...
                child: Text(
                  '${args.name}님의 감각신경수용기는 ${((100 - args.percent) / 100 * 21).round().toString()}일 후에 회복될 것입니다',
                  style: TextStyle(
                    fontWeight: FontWeight.w400,
                    color: Colors.black,
                    fontSize: 18,
                ...
                child: Column(
                  children: <Widget>[
                    Align(
                      alignment: Alignment.topCenter,
                      child: Text(
                        '  우리 뇌 속에 수백개의 세포들은 화학신호를 통해 서로 대화하여, 우리가 움직이고, 말하고, 생각하고, 느낄 수 있게 만들어 줍니다. 흡연자의 경우, 몸에 들어온 니코틴이 뇌에서 정상적으로 만들어진 화학신호를 흉내를 내고, 앞서 말한 뇌 속 세포들의 의사소통을 방해하여 기능을 떨어뜨립니다.',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 15,
                          fontWeight: FontWeight.w400,
                    ...
                    Align(
                      alignment: Alignment.topCenter,
                      child: Text(
                        '하지만 금연한다면, 우리의 뇌 속 세포들은 더 건강하고 생산적인 의사소통을 할 수 있게 됩니다.',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 15,
                          fontWeight: FontWeight.w400,
