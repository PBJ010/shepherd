...
class Body6 extends StatefulWidget {
  ...
  @override
  _Body6State createState() => _Body6State();
}
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Visibility(
                ...
                child: Text(
                  '${args.name}님의 미각이 ${((100 - args.percent) / 100 * 48).round().toString()}시간 후에 회복될 것입니다',
                  style: TextStyle(
                    fontWeight: FontWeight.w400,
                    color: Colors.black,
                    fontSize: 18,
                ...
                child: Column(
                  children: <Widget>[
                    Align(
                      alignment: Alignment.topCenter,
                      child: Text(
                        '  우리가 좋아하는 음식들을 즐기는데 입맛은 아주 중요한 역할을 합니다. 하지만 흡연을 하는 경우 미뢰 혹은 미각 세포를 둔하게 만들어, 우리가 좋아하던 음식을 이전만큼 즐겁게 먹지 못하게 만듭니다.',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 15,
                          fontWeight: FontWeight.w400,
                    ...
                    Align(
                      alignment: Alignment.topCenter,
                      child: Text(
                        '하지만 금연한다면, 우리가 입맛을 놓치고있었다는 사실을 깨닫게 될 것입니다. 담배 연기에서 벗어난다면 우리의 미각을 다시 새것처럼 되돌릴 수 있습니다.',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 15,
                          fontWeight: FontWeight.w400,
