...
class Info6 extends StatefulWidget {
  const Info6({Key? key, required this.name,}) : super(key: key);
  final String name;
                  ...
                  child: Align(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          firestore.collection((_auth.currentUser)!.uid).doc("causelist24").update({"data":_smokingDesire});
                          Navigator.push(
                            context,
                            MaterialPageRoute<void>(
                              builder: (BuildContext context) => Info7(int.parse(_smokingDesire.toString()), name: widget.name),
                            ),
                          );
                        },
