...
class Tool5 extends StatefulWidget {
  const Tool5({Key? key, required this.name,}) : super(key: key);
  final String name;
  @override
  State<Tool5> createState() => _Tool5State();
}

class _Tool5State extends State<Tool5> {
  @override
